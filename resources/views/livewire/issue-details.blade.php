<div class="border border-gray-500 overflow-hidden shadow sm:rounded-lg text-white">
    @push("scripts")
    ...
    <div class="border-gray-500 border-t">
        <div class="grid grid-flow-col">
            <div class="grid-span-2">
                <dl class="divide-gray-800 divide-y">
                    ...
                    <div
                            class="bg-gray-900 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
                            style=""
                    >
                        <dt class="text-sm font-medium text-white">
                            Attachments
        ...
        <div class="grid grid-flow-col gap-3 p-3 text-black">
