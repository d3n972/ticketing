<div class="overflow-hidden shadow text-white">
    ...
    <div class="py-5">
        <p class="mt-1 max-w-2xl text-sm text-white">
            {{ $issue->ticket_id }} was created by {{ $issue->author()->first()->name }} at {{$issue->getCreatedAt()}}
