<nav class="mt-10">
    ...
    <!-- Team Management -->
    <div class="border-gray-800 border-t inline-flex justify-center m-1 pt-2 text-gray-600 text-white w-full">
    ...
    >
        ...
        <span class="mx-3">{{ __('List tickets') }}</span>
    </a>
    ...
    >
        ...
        <span class="mx-3">{{ __('New ticket') }}</span>
    </a>
</nav>
